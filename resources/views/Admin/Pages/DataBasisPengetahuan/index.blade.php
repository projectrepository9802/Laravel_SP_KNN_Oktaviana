    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ URL::to('data-basis-pengetahuan/create') }}" class="btn btn-success mb-3">
                    ...
                    <tbody class="bg-secondary bg-gradient text-white">
                        ...
                        @foreach ($dataBasisPengetahuan as $basispengetahuan)
                            <tr class="text-white">
                                ...
                                <td class="align-middle text-center">
                                    <a href="{{ URL::to('data-basis-pengetahuan/' . $basispengetahuan->id . '/edit') }}"
                                        class="btn btn-warning text-white">
                                        <i class="fas fa-edit me-1"></i>
                                        Edit Data
                                    </a>
                                    <form action="{{ URL::to('data-basis-pengetahuan/' . $basispengetahuan->id) }}"
