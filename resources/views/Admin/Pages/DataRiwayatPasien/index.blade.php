                    ...
                    <tbody class="bg-secondary bg-gradient text-white">
                        ...
                        @foreach ($dataRiwayatPasien as $pasien)
                            <tr class="text-white">
                                ...
                                <td class="align-middle text-center">{{ $pasien->nama_lengkap }}</td>
                                <td class="align-middle text-center">{{ $pasien->jenis_kelamin }}</td>
                                <td class="align-middle text-center">{{ $pasien->umur }}</td>
                                <td class="align-middle text-center">
                                    <a href="{{ URL::to('data-riwayat-pasien/' . $pasien->id) }}" class="btn btn-primary">
                                        <i class="fas fa-eye me-1"></i>
                                        Lihat Data
                                    </a>
                                    <form action="{{ URL::to('data-riwayat-pasien/' . $pasien->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
