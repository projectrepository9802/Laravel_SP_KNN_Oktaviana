    ...
    <div class="container-fluid">
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <a href="{{ URL::to('data-gejala/create') }}" class="btn btn-success mb-3">
                    ...
                    <tbody class="bg-secondary bg-gradient text-white">
                        ...
                        @foreach ($dataGejala as $gejala)
                            <tr class="text-white">
                                ...
                                <td class="align-middle text-center">{{ $gejala->nilai_bobot }}</td>
                                <td class="align-middle text-center">
                                    <a href="{{ URL::to('data-gejala/' . $gejala->id . '/edit') }}"
                                        class="btn btn-warning text-white">
                                        <i class="fas fa-edit me-1"></i>
                                        Edit Data
                                    </a>
                                    <form action="{{ URL::to('data-gejala/' . $gejala->id) }}" method="POST"
                                        class="d-inline">
                                        @csrf
                                        @method('DELETE')
